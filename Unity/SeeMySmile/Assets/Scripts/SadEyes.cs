...
public class SadEyes : MonoBehaviour
{
    ...
    {   
        ...
        skinnedMeshRenderer.SetBlendShapeWeight((int)BlendShapesEnum.CheekSquint_L, value); // 12.7
        skinnedMeshRenderer.SetBlendShapeWeight((int)BlendShapesEnum.CheekSquint_R, value); // 28.7
        skinnedMeshRenderer.SetBlendShapeWeight((int)BlendShapesEnum.LipsPucker, value/2); // 48.6
    }
}
